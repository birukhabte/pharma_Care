        ...
        {!collapsed ? (
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-50 cursor-pointer group">
            <div className="w-8 h-8 rounded-full bg-teal-100 flex items-center justify-center flex-shrink-0">
              <span className="text-sm font-semibold text-teal-700">RP</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-slate-800 truncate">Ravi Patel</p>
              <p className="text-xs text-slate-400 truncate">Head Pharmacist</p>
            </div>
            <LogOut
              size={14}
